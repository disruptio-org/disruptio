  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{ color: 'var(--border-strong)', fontSize: '11px', letterSpacing: '.08em' }}>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: '380px' }}>
          <div style={{ fontSize: '26px', fontWeight: 700, color: 'var(--text-primary)' }}>Welcome back.</div>
          <div style={{ marginTop: '8px', color: 'var(--text-muted)', fontSize: '14px' }}>Enter your credentials.</div>
          <div style={{ marginTop: '36px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            {error && (
              <div style={{ color: 'var(--accent)', fontSize: '12px', marginTop: '-8px' }}>{error}</div>
            )}
          ...
          <div style={{ marginTop: '24px', color: 'var(--text-ghost)', fontSize: '11px' }}>
            No account?{' '}
            <span style={{ color: 'var(--text-muted)', borderBottom: '1px solid var(--border-input)', cursor: 'pointer' }}>
