          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '9px', color: '#4A4A4A', marginTop: '4px' }}>
                ...
                {aiProvider === 'deepseek' && 'DeepSeek API key from platform.deepseek.com'}
                {aiProvider === 'xai' && 'xAI API key from console.x.ai'}
                {aiProvider === 'mistral' && 'Mistral API key from console.mistral.ai'}
              </div>
            </div>
