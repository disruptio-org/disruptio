...
export const DEFAULT_AGENTS = [
  {
    ...
    allowedContext: JSON.stringify(['Product Context', 'Tech View', 'GitHub Repo']),
    model: 'gpt-4',
    temperature: 0.3,
  },
  {
    ...
    allowedContext: JSON.stringify(['Personas', 'UX/UI Rules', 'Design Style']),
    model: 'gpt-4',
    temperature: 0.4,
  },
  {
    ...
    allowedContext: JSON.stringify(['Product Context', 'Personas', 'Tech View']),
    model: 'gpt-4',
    temperature: 0.2,
    enabled: false,
  },
  {
    ...
    allowedContext: JSON.stringify(['Product Context', 'Personas', 'UX/UI Rules', 'Tech View']),
    model: 'gpt-4',
    temperature: 0.2,
  },
];
